...
type IconProps = {
  name: 'folder' | 'folder-open' | 'chevron-down' | 'chevron-right' | 'plus' | 'trash' | 'document' | 'document-add' | 'check' | 'circle' | 'edit' | 'panel-left-close' | 'panel-left-open' | 'pause' | 'archive' | 'dots-vertical' | 'upload' | 'download' | 'user' | 'log-out';
  className?: string;
};
